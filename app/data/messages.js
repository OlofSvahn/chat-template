export const messages = [
  ...
  },
  {
    ...
    timeStamp: new Date('2021-12-07 12:05'),
    isUserMessage: true,
  },
  {
    id: '3',
    ...
    userId: '3',
    timeStamp: new Date('2021-12-08 12:22'),
    isUserMessage: false,
  },
  {
    id: '4',
  ...
  {
    id: '9',
    text: 'Varför skriver alla på english in den här chatten? Jag är minsann inte från USA eller England eller Grekland för den delen, inte för att någon frågade, men ändå. Hellre säker än sölig, som jag alltid säger. Jahopp, någon som har någon kul info om Hitler eller?',
    userId: '9',
    timeStamp: new Date('2021-12-13 10:30'),
    isUserMessage: true,
  },  
  {
    id: '10',
    text: 'GIfflar är asgött ju! Oj, fel chatt. Lol. Vet att Hitler hade en hund, eller så var det en stor råtta. Vem vet, egentligen.',
    userId: '10',
    timeStamp: new Date('2021-12-13 14:05'),
    isUserMessage: false,
  },
];
